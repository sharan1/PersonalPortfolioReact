  ...
  render(){
    ...
    return(<Section
      ...
      fixed_column={<SideBlock {...this.props}>
        <div>
          <div><i className="icon-energy" style={{color:'#d16a10'}}/></div>
          <div className="section-title" >Major Projects</div>
      ...
      >
      <div style={{borderBottom:'5px solid #0C1926', background: '#d16a10'}}>
